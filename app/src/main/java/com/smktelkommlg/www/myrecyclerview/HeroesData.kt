    ...
    private val data = arrayOf(
        ...
        arrayOf(
            ...
            "Raden Mas Soewardi Soerjaningrat (EBI: Suwardi\n" +
                    ...
                    "suatu lembaga pendidikan yang memberikan kesempatan bagi para pribumi untuk bisa memperoleh hak pendidikan seperti halnya para\n" +
        ...
        arrayOf(
            "Soekarno",
            "Dr.(H.C.) Ir. H. Soekarno (ER, EYD: Sukarno, nama lahir: Koesno Sosrodihardjo) (lahir di Surabaya, Jawa Timur, 6\n" +
